...
# sleep(5)  
# camera.stop_preview()  
def send_an_email(currentname):  
    toaddr = 'abc@gmail.com'      # To id 
    me = 'abc@gmail.com'          # your id
    subject = "New Guest : " + currentname             # Subject
    ...
    try:  
       ...
       s.starttls()  
       s.ehlo()  
       s.login(user = 'abc@gmail.com', password = '************')  # User id & password
       #s.send_message(msg)  
